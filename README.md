...
## 2) Problem domain and motivation 
...
- **Integration tests (planned/optional):** WebSocket event flows (session-history,   
- **Performance checks:** basic responsiveness and load checks.
...
## 7) Links 
- **Source Code:** https://github.com/dionabou/ase285-chatgpt-clone  
